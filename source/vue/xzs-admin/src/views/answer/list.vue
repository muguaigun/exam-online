  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="tableData" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column width="220px" label="操作" align="center">
        <template slot-scope="{row}">
            <el-button  size="mini"  type="danger" @click="$router.push({path:'edit',query:{id:row.id}})"  v-if="row.status === 1" >批改</el-button>
            <el-button  size="mini" @click="$router.push({path:'read',query:{id:row.id}})" >查看试卷</el-button>
        </template>
